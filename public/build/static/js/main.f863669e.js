!(function (e) {
	...
	function (e, t, n) {
		...
		var r = n(2),
			...
			l = function (e, t) {
				var n = e;
				return (
					(n.instancePool = []), (n.getPooled = t || c), n.poolSize || (n.poolSize = 10), (n.release = u), n
				);
			},
			p = {
				addPoolingTo: l,
				...
				(n(0),
				{
					...
					injectDOMPropertyConfig: function (e) {
						...
						for (var p in n) {
							...
							if (
								(h.hasBooleanValue + h.hasNumericValue + h.hasOverloadedBooleanValue <= 1 || o("50", p),
								u.hasOwnProperty(p))
							) {
								var m = u[p];
								h.attributeName = m;
			...
			i =
				...
				n(1),
				{
					mountComponent: function (e, t, n, o, i, a) {
						...
						return (
							e._currentElement && null != e._currentElement.ref && t.getReactMountReady().enqueue(r, e),
							s
						);
					},
	...
	function (e, t, n) {
		...
		var i = n(3),
			a = n(11),
			s = (n(1), n(86), Object.prototype.hasOwnProperty),
			u = n(84),
	...
	function (e, t, n) {
		...
		function r(e) {
			var t,
				n = e.keyCode;
			return (
				"charCode" in e ? 0 === (t = e.charCode) && 13 === n && (t = 13) : (t = n), t >= 32 || 13 === t ? t : 0
			);
		}
		e.exports = r;
	},
	...
	function (e, t, n) {
		...
		function r(e) {
			return (
				!!c.hasOwnProperty(e) || (!u.hasOwnProperty(e) && (s.test(e) ? ((c[e] = !0), !0) : ((u[e] = !0), !1)))
			);
		}
		function o(e, t) {
			return (
	...
	function (e, t, n) {
		...
		function r() {
			return (
				!i && o.canUseDOM && (i = "textContent" in document.documentElement ? "textContent" : "innerText"), i
			);
		}
		var o = n(5),
			i = null;
		...
		var i =
			...
			l = function (e, t) {
				var n = e.children,
					...
					c = e.width,
					l = e.height,
					p = o(e, ["children", "color", "size", "style", "width", "height"]),
					f = t.reactIconBase,
					d = void 0 === f ? {} : f,
					h = a || d.size || "1em";
				return s.default.createElement(
					...
					i(
						...
						d,
						p,
						{ style: i({ verticalAlign: "middle", color: r || d.color }, d.style || {}, u) }
					)
				);
			};
		(l.propTypes = {
			...
			(l.contextTypes = { reactIconBase: c.default.shape(l.propTypes) }),
			(t.default = l),
			(e.exports = t.default);
	},
	function (e, t, n) {
	...
	function (e, t, n) {
		"use strict";
		"undefined" === typeof Promise && (n(132).enable(), (window.Promise = n(131))), n(216), (Object.assign = n(3));
	},
	function (e, t, n) {
		"use strict";
		(function (t) {
					...
					l(t, [
						{
							key: "render",
							value: function () {
								return s.a.createElement("div", { id: "App__container" }, s.a.createElement(c.a, null));
							}
						}
					]),
					t
		...
		var a = n(13),
			...
			m = (function (e) {
				function t() {
					...
					return (
						(e.state = { messages: [], text: "" }),
						(e.handleChange = e.handleChange.bind(e)),
						(e.createMessage = e.createMessage.bind(e)),
						(e.editMessage = e.editMessage.bind(e)),
						(e.removeMessage = e.removeMessage.bind(e)),
						e
					);
				}
				return (
					...
					h(t, [
						...
						},
						{
							...
							value: function (e) {
								...
								"Enter" === e.key &&
									0 !== r.length &&
									(l.a.post(p.a, { text: r, time: n.i(d.a)() }).then(function (e) {
										t.setState({ messages: e.data });
									}),
									this.setState({ text: "" }));
							}
						},
						{
							...
							value: function (e, t) {
								var n = this;
								console.log("editMessage:", e, t),
									l.a.put(p.a + "/" + e, { text: t }).then(function (e) {
										n.setState({ messages: e.data });
									});
							}
						},
						{
							...
							value: function (e) {
								var t = this;
								l.a.delete(p.a + "/" + e).then(function (e) {
									t.setState({ messages: e.data });
								});
							}
						},
						{
							...
							value: function () {
								...
								return s.a.createElement(
									"div",
									{ id: "ChatWindow__container" },
									s.a.createElement(
										"div",
										{ id: "ChatWindow__messagesParentContainer" },
										s.a.createElement(
											"div",
											{ id: "ChatWindow__messagesChildContainer" },
									...
									s.a.createElement(
										"div",
										{ id: "ChatWindow__newMessageContainer" },
		...
		var a = n(13),
			...
			h = (function (e) {
				function t(e) {
					...
					return (
						(n.state = { editting: !1, text: n.props.text }),
						(n.handleChange = n.handleChange.bind(n)),
						(n.edit = n.edit.bind(n)),
						n
					);
				}
				return (
						...
						},
						{
							...
							value: function (e) {
								var t = this.state.text,
									...
									r = n.id,
									o = n.edit;
								"Enter" === e.key && 0 !== t.length && (o(r, t), this.setState({ editting: !1 }));
							}
						},
						{
							key: "render",
							value: function () {
								var e = this,
									...
									o = t.time,
									i = (t.edit, t.remove),
									a = this.state.editting;
								return (
									console.log(n, r),
									s.a.createElement(
										"div",
										{ className: "Message__container" },
										s.a.createElement("span", { className: "Message__time" }, o),
										a
											? s.a.createElement("input", {
											...
											: s.a.createElement("span", { className: "Message__text" }, r),
										s.a.createElement(
											"span",
											{
												className: "Message__edit",
												onClick: function () {
													return e.setState({ editting: !e.state.editting, text: r });
												}
											},
											" ",
	...
	function (e, t, n) {
		...
		function u(e, t, n, r) {
			var u, c;
			if ((b ? (u = o(e)) : k ? a(e, n) && (u = T.compositionEnd) : i(e, n) && (u = T.compositionStart), !u))
				return null;
			E &&
	...
	function (e, t, n) {
		...
		var D = !1;
		w.canUseDOM && (D = N("input") && (!("documentMode" in document) || document.documentMode > 9));
		var U = {
			eventTypes: O,
				...
				updateComponent: function (e, t, n, r, o) {
					...
					this._pendingForceUpdate ||
						(i.shouldComponentUpdate
							...
							: this._compositeType === y.PureClass && (f = !v(c, l) || !v(i.state, p))),
						(this._updateBatchNumber = null),
						f
		...
		function o(e, t) {
			t &&
				...
				null != t.dangerouslySetInnerHTML &&
					...
					("object" === typeof t.dangerouslySetInnerHTML && W in t.dangerouslySetInnerHTML) || v("61")),
		...
		function p() {
			...
			switch ((t || v("64"), e._tag)) {
				...
				case "audio":
					...
					for (var n in z)
						z.hasOwnProperty(n) && e._wrapperState.listeners.push(P.trapBubbledEvent(n, z[n], t));
					break;
				case "source":
			...
			(m.Mixin = {
				mountComponent: function (e, t, n, r) {
					...
					if (e.useCreateElement) {
						...
						d = !x && Y[this._tag] ? E + "/>" : E + ">" + x + "</" + this._currentElement.type + ">";
					}
					switch (this._tag) {
						case "input":
							...
							if (null != o)
								if (V.hasOwnProperty(r)) o && i(this, r, o, e);
									...
									null != this._tag && h(this._tag, t)
										? H.hasOwnProperty(r) || (a = w.createMarkupForCustomAttribute(r, o))
				...
				updateComponent: function (e, t, n, r) {
					...
					switch (
						(o(this, a), this._updateDOMProperties(i, a, e), this._updateDOMChildren(i, a, e, r), this._tag)
					) {
						case "input":
				...
				_updateDOMProperties: function (e, t, n) {
						...
						if (!t.hasOwnProperty(r) && e.hasOwnProperty(r) && null != e[r])
							if ("style" === r) {
								...
								V.hasOwnProperty(r)
									? e[r] && j(this, r)
									: h(this._tag, e)
									? H.hasOwnProperty(r) || w.deleteValueForAttribute(F(this), r)
					...
					for (r in t) {
						...
						if (t.hasOwnProperty(r) && u !== c && (null != u || null != c))
							if ("style" === r)
								if (
									(u ? (u = this._previousStyleCopy = g({}, u)) : (this._previousStyleCopy = null), c)
								) {
									for (o in c)
										!c.hasOwnProperty(o) ||
							...
							else if (h(this._tag, t)) H.hasOwnProperty(r) || w.setValueForAttribute(F(this), r, u);
	...
	function (e, t, n) {
		...
		function i(e) {
			...
			if ("radio" === t.type && null != o) {
				...
				for (
					var u = s.querySelectorAll("input[name=" + JSON.stringify("" + o) + '][type="radio"]'), f = 0;
					f < u.length;
					f++
				) {
					var d = u[f];
					...
					Mixin: {
						...
						_reconcilerUpdateChildren: function (e, t, n, r, o, i) {
							var a,
								s = 0;
							return (
								(a = h(t, s)), d.updateChildren(e, a, n, r, o, this, this._hostContainerInfo, i, s), a
							);
						},
									...
									if (a.hasOwnProperty(s)) {
										...
										v === g
											...
											: (v && (d = Math.max(v._mountIndex, d)),
											  (l = u(l, this._mountChildAtIndex(g, i[h], m, p, t, n))),
											  h++),
											p++,
											(m = f.getHostNode(g));
									}
	...
	function (e, t, n) {
		...
		function u(e, t, n) {
			...
			Array.isArray(u)
				...
				: null != u &&
				  (m.isValidElement(u) &&
						(u = m.cloneAndReplaceKey(u, i + (!u.key || (t && t.key === u.key) ? "" : r(u.key) + "/") + n)),
				  o.push(u));
		}
...
//# sourceMappingURL=main.f863669e.js.map
